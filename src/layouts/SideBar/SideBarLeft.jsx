...
export default function SideBarLeft({ isMenuLeft, setMenuLeft }) {
                ...
                <div className="sidenav-nav-container">
                    <div className="widget_nav_menu mb-3">
                        <div className="menu-sidenav-menu-container">
                            <button className="btn btn-radius btn-sm btn-secondary toggle-sidebar" onClick={() => setMenuLeft(false)}>
                                    ...
                                    <Accordion>
                                        ...
                                        <Accordion.Collapse 
                                                ...
                                                eventKey="0">
                                                    ...
                                                    {
                                                        cateIndexes.map((item, i) => (
                                                            <li key={item.key} className="menu-item menu-hover">
                                                                <Link to={`/the-loai/${item.key}`} style={{color: `${color[i % 6]}`}}>{item.title}</Link>
                                                            </li>
                                                            ))
                                                      }
                                                    </ul>
